package com.koolsoft.samplesentences.server.fulltextsearch;
...
public enum SearchIndexManager {
	...
	public Document retrieveDocument(String documentId) {
		//Setup the Index
		IndexSpec indexSpec = IndexSpec.newBuilder().setName(Constants.TOPIC_INDEX).build(); 
		Index index = SearchServiceFactory.getSearchService().getIndex(indexSpec);
	...
	public Document retrieveDocumentWord(String documentId) {
		//Setup the Index
	...
	public Results<ScoredDocument> retrieveDocumentsWord(String searchText) {
		//Setup the Index
		IndexSpec indexSpec = IndexSpec.newBuilder().setName(Constants.WORD_INDEX).build(); 
		Index index = SearchServiceFactory.getSearchService().getIndex(indexSpec);
